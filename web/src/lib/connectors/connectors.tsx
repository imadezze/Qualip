  ...
  google_drive: {
            ...
            fields: [
              {
                ...
                description: (currentCredential) => {
                  return currentCredential?.credential_json?.google_tokens
                    ? "This will allow CertiBot to index everything in the shared drives you have access to."
                    : "This will allow CertiBot to index everything in your Organization's shared drives.";
                },
              ...
              },
              {
                ...
                description: (currentCredential) => {
                  return currentCredential?.credential_json?.google_tokens
                    ? "This will allow CertiBot to index everything in your My Drive."
                    : "This will allow CertiBot to index everything in everyone's My Drives.";
                },
              ...
              },
              {
                type: "checkbox",
                description:
                  "This will allow CertiBot to index all files shared with you.",
    ...
    advanced_values: [
      ...
      },
      {
        ...
        description:
          "When enabled, CertiBot skips files that are shared broadly (domain or public) but require the link to access.",
            ...
            fields: [
              {
                ...
                optional: true,
                description:
                  "Specify the Salesforce object types you want us to index. If unsure, don't specify any objects and CertiBot will default to indexing by 'Account'." +
...
• Specifying sites currently works for SharePoint instances using English, Spanish, or German. Contact the CertiBot team if you need another language supported.
`,
      },
    ],
    advanced_values: [
